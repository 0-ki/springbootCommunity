...
import com.study.springboot.domain.enums.SocialType;
import com.study.springboot.oauth.ClientResources;
import com.study.springboot.oauth.UserTokenService;
...
import static com.study.springboot.domain.enums.SocialType.*;

@Configuration
@EnableWebSecurity // 웹에서 시큐리티 기능을 사용하겠다!
@EnableOAuth2Client
public class SecurityConfig extends WebSecurityConfigurerAdapter { // 어댑터에서 configure 메서드를 오버라이드 해서 커스텀
